      ...
      documents: [
        {
          ...
          url: 'https://example.slack.com/archives/ask-people/p1699027927.191979?thread_ts=1699026229.534229',
          text: '',
        },
        {
          ...
          url: 'https://example.slack.com/archives/ask-people/p1698415906.928069?thread_ts=1698354798.078099',
          text: '',
        },
      ],
      is_finished: true,
...
*Sources:*
- <https://example.slack.com/archives/ask-people/p1699027927.191979?thread_ts=1699026229.534229|Corporate rate>
- <https://example.slack.com/archives/ask-people/p1698415906.928069?thread_ts=1698354798.078099|Le Meridien Hotel>`);
  });
  ...
  test('combine duplicate RAG response links into one citation and exclude documents that are not cited', () => {
    const chatResponse = {
      ...
      citations: [
        ...
        },
        {
          ...
          document_ids: ['test-document-id-2'],
        },
        {
          start: 138,
          end: 162,
      ...
      documents: [
        ...
        },
        {
          ...
          url: 'https://example.com/hotels/toronto',
          text: '',
        },
        {
    ...
    expect(formattedCitations).toEqual(`
*Sources:*
- <https://example.com/hotels/toronto|Toronto Hotels>`);
  });
